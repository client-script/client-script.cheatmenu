--Instructions: To loop go to line 166 and change the USER, FILE, and REPO sections. You may also use another such as pastebin. To edit lag reducing settings go to line and change the values. To edit messages go to line 150.
